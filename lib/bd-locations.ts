...
export const BD_LOCATIONS: Division[] = [
    {
        name: "Dhaka",
        districts: [
            { name: "Dhaka", thanas: ["Adabor", "Ashulia", "Badda", "Banani", "Bangshal", "Bhashantek", "Bimanbandar", "Cantonment", "Chawkbazar", "Dakshinkhan", "Darus Salam", "Demra", "Dhamrai", "Dhanmondi", "Dohar", "Gendaria", "Gulshan", "Hatirjheel", "Hazaribagh", "Jatrabari", "Kadamtali", "Kafrul", "Kalabagan", "Kamrangirchar", "Keraniganj", "Khilgaon", "Khilkhet", "Kotwali", "Lalbagh", "Mirpur", "Mohammadpur", "Motijheel", "Mugda", "Nawabganj", "New Market", "Pallabi", "Paltan", "Ramna", "Rampura", "Rayer Bazar", "Rupnagar", "Sabujbagh", "Savar", "Shah Ali", "Shahbagh", "Shahjahanpur", "Sher-e-Bangla Nagar", "Shyampur", "South Keraniganj", "Sutrapur", "Tejgaon", "Tejgaon Industrial Area", "Turag", "Uttara", "Uttara East", "Uttara West", "Uttarkhan", "Vatara", "Wari"] },
