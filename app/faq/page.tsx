...
const faqs_bn = [
    {
        ...
        a: "শুধুমাত্র বুকিং ওয়েডজেটে আপনার পিকআপ এবং ড্রপ লোকেশন দিন, পছন্দের ট্রাকের ধরন এবং তারিখ নির্বাচন করুন, তারপর 'ভাড়া দেখুন' ক্লিক করুন। আপনি কয়েক মিনিটের মধ্যে ইনস্ট্যান্ট মূল্য erhalten এবং বুকিং কনফার্ম করতে পারবেন।"
    },
    {
        q: "ভাড়া কিভাবে হিসাব করা হয়?",
        a: "ভাড়া নির্ধারিত হয় দূরত্ব, ট্রাকের ধরন, মালামালের ওজন এবং ডেলিভারির তীব্রতার ওপর ভিত্তি করে। আমাদের স্বচ্ছ মূল্য নীতি ensures আপনি কোনো বুকিং কনফার্ম করার আগে সম্পূর্ণ খরচ দেখতে পারবেন।"
    },
    {
        q: "ট্রানজিটে আমার মালামালের বিমা কভারেজ আছে?",
        a: "হ্যাঁ, ট্রাক দরকারের মাধ্যমে সব শিপমেন্টে বেসিক বিমা কভারেজ অন্তর্ভুক্ত। উচ্চ মূল্যের মালামালের জন্য আমরা বুকিং প্রক্রিয়ায় প্রিমিয়াম বিমা কিনতে সুপারিশ করছি।"
    },
    {
        q: "আমি কি রিয়েল-টাইমে আমার শিপমেন্ট ট্র্যাক করতে পারব?",
        a: "অবশ্যই। আপনার বুকিং কনফার্ম হওয়ার পর আপনি আমাদের অ্যাপ বা ওয়েবসাইটের মাধ্যমে লাইভ শিপমেন্ট ট্র্যাক করতে পারবেন।毎度 ডেলিভারি মাইলস্টোনে SMS এবং পpush নোটিফিকেশন erhalten করবেন।"
    },
    {
        q: "কোন পেমেন্ট পদ্ধতি গ্রহণযোগ্য?",
        a: "ক্যাশ অন ডেলিভারি, বিকাশ, নগদ, রকেট এবং সব প্রধান ব্যাংক কার্ড গ্রহণ করা হয়। কর্পোরেট ক্লায়েন্টরা মাসিক বিলিংয়ের জন্য net-15 বা net-30 শর্তে বেছে নিতে পারেন।"
    },
    {
        q: "আমি কিভাবে বুকিং বাতিল বা পুনরায় সময় নির্ধারণ করব?",
        a: "শিডিউল्ड পিকআপের ৪ ঘণ্টা আগে পর্যন্ত আপনি আপনার ড্যাশবোর্ডের মাধ্যমে বুকিং বাতিল বা পুনরায় সময় নির্ধারণ করতে পারবেন। সময় এবং ট্রাকের অবস্থার ওপর ভিত্তি করে বাতিল চার্জ প্রযোজ্য হতে পারে।"
    },
    {
        q: "সব ড্রাইভার ভেরিফাইড আছে?",
        a: "হ্যাঁ, আমাদের প্ল্যাটফর্মের প্রতিটি ড্রাইভার কঠোর ব্যাকগ্রাউন্ড চেক, লাইসেন্স যাচাইকরণ এবং পর্যায়ক্রমিক নিরাপত্তা প্রশিক্ষণের মাধ্যমে undergoes happens। শুধুমাত্র ভেরিফাইড ড্রাইভাররা শিপমেন্টের জন্য নিয়োগ করা হয়।"
    },
    {
        q: "আপনারা ২৪/৭ সেবা দান করেন?",
        a: "ট্রাক দরকার ২৪/৭, ৩৬৫ দিন সেবা দান করে। আপনি যেকোনো সময়,包括 সপ্তাহান্ত এবং সরকারি ছুটির দিনও ট্রাক বুক করতে এবং শিপমেন্ট ট্র্যাক করতে পারবেন।"
    }
];
