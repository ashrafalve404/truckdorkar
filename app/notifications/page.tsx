...
export default function UserNotificationsPage() {
    ...
    return (
        <DashboardLayout requiredRole="USER">
            <header className="mb-10 flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-700 font-bold">
                        {t("Stay updated with your booking status and system announcements.", "আপনার বুকিং স্ট্যাটাস এবং সিস্টেম ঘোষণা সম্পর্কে আপডেট থাকুন।")}
                    </p>
                </div>
            ...
            <div className="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden text-slate-950">
                {loading ? (
                    ...
                    <div className="p-20 text-center">
                        <RiNotification3Fill className="w-12 h-12 text-slate-300 mx-auto mb-4" />
                    ...
                    <div className="divide-y divide-slate-50">
                        {notifications.map((notif) => {
                            const Icon = iconMap[notif.type] || RiNotification3Fill;
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between gap-4 mb-1">
                                            ...
                                            <span className="text-xs text-slate-500 font-bold whitespace-nowrap tracking-tight">{getTimeAgo(notif.createdAt)}</span>
                                        </div>
                ...
                {notifications.length > 0 && (
                    <div className="p-5 bg-slate-50 flex items-center justify-between">
                        <span className="text-xs text-slate-500 font-bold">
                            {notifications.filter((n) => !n.isRead).length} {t("unread notifications", "টি আনরেড নোটিফিকেশন")}
                        </span>
                        <button
