                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl mx-auto">
                        ...
                        <div className="space-y-6">
                            <p className="text-gray-600 text-lg leading-relaxed mb-8">
                                {isBn
                                    ? "ট্রাক দরকারে আমরা আপনার ব্যক্তিগত তথ্য ও গোপনীয়তার অধিকার রক্ষা করতে অঙ্গীকারিত আছি। এই গোপনীয়তা নীতি ব্যাখ্যা করে যে আমাদের প্ল্যাটফর্ম ব্যবহার করার সময় мыimizing.php আপনার তথ্য কীভাবে সংগ্রহ, ব্যবহার, প্রকাশ ও সুরক্ষিত করছি।"
                            ...
                            {isBn ? (
                                <div className="space-y-6">
                                    {[
                                        { t: "১. আমরা যে তথ্য সংগ্রহ করি", b: "আমরা নাম, ফোন নম্বর, ইমেইল ঠিকানা ও ডেলিভারি বিবরণ vous регистрация বা বুকিংয়ের সময় সরাসরি সংগ্রহ করি। ব্যবহারের ডেটা, ডিভাইসের তথ্য ও অবস্থানের ডেটাও（সম্মতিতে）সংগ্রহ করি সেবা উন্নত করতে।" },
                                        { t: "২. আপনার তথ্য কেমন ব্যবহার করি", b: "বুকিং প্রক্রিয়াকরণ, ড্রাইভার যাচাইকরণ, গ্রাহক সহায়তা, আপডেট পাঠানো, প্ল্যাটফর্ম উন্নয়ন ও আইনি দায়িত্ব পালনের জন্য ব্যবহার করা হয়। আমরা কখনও ব্যক্তিগত ডেটা বিক্রি করি না।" },
                                        { t: "৩. তথ্য শেয়ারিং", b: "শুধুমাত্র নির্ভরযোগ্য পরিষেবা প্রদানকারীদের（ড্রাইভার, পেমেন্ট প্রসেসর, ডেলিভারি পার্টনার）সাথে ডেটা শেয়ার করা হয় যা বুকিং সম্পূর্ণ করার জন্য অপরিহার্য। সব তৃতীয় পক্ষ গোপনীয়তা চুক্তিরbound।" },
                                        { t: "৪. ডেটা সুরক্ষা", b: "এনক্রিপশন, সুরক্ষিত সার্ভার ও নিয়মিত সুরক্ষা অডিটসহ industria-standard ব্যবস্থা ব্যবহার করা হয় অননুমোদিত অ্যাক্সেস, পরিবর্তন বা ধ্বংস থেকে রক্ষা করতে।" },
                                        { t: "৫. আপনার অধিকার", b: "আপনি যেকোনো সময় আপনার ব্যক্তিগত ডেটা অ্যাক্সেস, আপডেট বা মুছে ফেলার অধিকার রাখেন। সাপোর্ট টিমের মাধ্যমে opt out করতে ও ডেটা পোর্টেবিলিটি অনুরোধ করতে পারেন।" },
                                        { t: "৬. কুকিজ", b: "প্ল্যাটফর্ম কার্যক্ষমতা নিশ্চিত করতে essential কুকিজ ও ব্যবহারকারীর অভিজ্ঞতা উন্নত করতে ঐচ্ছিক অ্যানালিটিক্স কুকিজ ব্যবহার করা হয়। ব্রাউজার সেটিংসের মাধ্যমে পরিচালনা করতে পারেন।" },
                                        { t: "৭. শিশুদের গোপনীয়তা", b: "সেবাগুলো ১৮ বছরের নিচের ব্যবহারকারীদের জন্য নয়। আমরা knowingly শিশুদের কাছ থেকে ব্যক্তিগত তথ্য সংগ্রহ করি না। শিশুদের সাথে সংযোগ থাকলে অবশ্যয যোগাযোগ করুন।" },
                                        { t: "৮. নীতিতে পরিবর্তন", b: "আমরা সময়ে সময়ে এই নীতি আপডেট করতে পারি। নতুন নীতি পোস্ট করা হবে ও 'শেষ আপডেট' তারিখ পরিবর্তন হবে যেকোনো মূল পরিবর্তन নোট করব।" },
                                        { t: "৯. যোগাযোগ", b: "প্রশ্ন থাকলে privacy@truckdorkar.com এ যোগাযোগ করুন অথবা 01826-110036 নম্বরে কল করুন। ২৪/৭ সাপোর্ট উপলব্ধ।" }
                                    ].map((item, idx) => (
                                ...
                                <div className="space-y-6">
                                    {[
                                        ...
                                        { t: "9. Contact Us", b: "For questions, contact privacy@truckdorkar.com or call 01826-110036. Our 24/7 support team is ready to assist." }
                                    ].map((item, idx) => (
                                        <div key={idx} className="bg-light-gray p-6 md:p-8 rounded-xl">
                                            <h3 className="text-lg font-bold text-black mb-3">{item.t}</h3>
                                            <p className="text-gray-600 leading-relaxed">{item.b}</p>
