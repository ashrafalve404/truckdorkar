            ...
            <main className="pt-24 md:pt-32 pb-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-12">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-2xl mx-auto text-center">
                        ...
                        <p className="text-slate-700 font-bold text-lg mb-12">{t("Join our network of verified drivers.", "আমাদের ভেরিফাইড ড্রাইভারদের নেটওয়ার্কে যোগ দিন।")}</p>
                        <div className="bg-slate-50 p-8 rounded-2xl text-slate-700 font-bold">
