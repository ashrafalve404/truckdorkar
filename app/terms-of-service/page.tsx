                            ...
                            {isBn ? (
                                <div className="space-y-6">
                                    {[
                                        ...
                                        { t: "২. সেবার বিবরণ", b: "ট্রাক দরকার একটি ডিজিটাল লজিস্টিক প্ল্যাটফর্ম যা শিপার এবং ট্রাক মালিকদের সংযোগ করে। আমরা বুকিং ও পেমেন্ট সহায়তা করি কিন্তু পরিবহন প北斗提供服务 করি না।" },
