...
import { Navigation, ShieldCheck, CreditCard, Globe, Headphones, Zap } from "lucide-react";
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="p-8 bg-black border border-white/5 hover:border-primary/50 transition-all rounded-md group"
                        >
                            <feature.icon className="w-10 h-10 text-primary mb-6 transition-transform group-hover:scale-110 duration-300" />
